/* eslint-disable tailwindcss/no-unnecessary-arbitrary-value */ //linting bug
...
export default function Checkbox(p: ICheckboxProps) {
  ...
  return (
    <div
      ...
      className={`w-fit items-start rounded p-2 ${p.border ? `border-2 ${isHovered ? "border-tertiary-600" : "border-tertiary-500"} ${isFocused ? "!border-primary" : ""}` : "border-2 border-transparent"}`}
    >
